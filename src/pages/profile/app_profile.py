...
def _settings_state(
    ...
    return {
        ...
        "recetas_reduced_categories": bool(reduced_categories),
...
def _load_profile_settings(request: gr.Request):
    ...
    if not email:
        base_state = _settings_state(RECETAS_VIEW_MODE_ICON, True, True, True)
    ...
    reduced_categories = bool(preferences.get("recetas_reduced_categories"))
    show_thermomix = bool(preferences.get("recetas_show_thermomix"))
    current_state = _settings_state(view_mode, only_verified, reduced_categories, show_thermomix)
    ...
    return (
        ...
        gr.update(value=reduced_categories, interactive=True),
...
def _auto_save_profile_settings(
    ...
    recetas_reduced_categories: object,
    recetas_show_thermomix: object,
    current_state: Dict[str, object] | None,
    autosave_enabled: bool,
    request: gr.Request,
):
    previous_state = current_state or _settings_state(RECETAS_VIEW_MODE_ICON, True, True, True)
    next_state = _settings_state(
        recetas_view_mode,
        recetas_only_verified,
        recetas_reduced_categories,
    ...
    if (
        ...
        and bool(previous_state.get("recetas_reduced_categories", True)) == bool(next_state.get("recetas_reduced_categories"))
    ...
    preferences = set_user_preferences(
        ...
        recetas_reduced_categories=next_state["recetas_reduced_categories"],
    ...
    saved_state = _settings_state(
        ...
        preferences.get("recetas_reduced_categories"),
    ...
    categorias_label = "reducidas" if bool(saved_state.get("recetas_reduced_categories")) else "todas"
    ...
    return (
        ...
        (
            ...
            f"Categorías: {categorias_label}. Thermomix: {thermomix_label}."
        ),
    )
...
def make_profile_app() -> gr.Blocks:
    ...
    with gr.Blocks(
        ...
        settings_state = gr.State(_settings_state(RECETAS_VIEW_MODE_ICON, True, True, True))
        ...
        with gr.Column(elem_id="profile-shell"):
            ...
            with gr.Column(elem_id="profile-panel"):
                ...
                recetas_reduced_categories = gr.Checkbox(
                    value=True,
                    label="Usar categorías reducidas",
                    interactive=True,
                    elem_id="profile-recetas-reduced-categories",
                )
        ...
        recetas_reduced_categories.change(
            recipe_settings_handler,
            inputs=recipe_settings_inputs,
            outputs=[settings_state, status_md],
            show_progress=False,
